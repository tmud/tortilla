...
function send.description()
  ...
  s = s..'Внимание! Данный плагин нарушает правила мультинга на некоторых мад-серверах.\r\n'
  s = s..'Если на сервере запрещен мультинг, то вы рискуете быть заблокированным.\r\n'
  s = s..'Плагин добавляет команды '..p..'send и '..p..'sendall, которые отправляют команды в другие окна.\r\n'
  s = s..'Формат команд: '..p..'send {окно} {команда} - отправляет команду в нужный экземпляр клиента.\r\n'
