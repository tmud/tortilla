...
local texts = {
  ...
  'На сайте клиента можно найти и другие плагины, которых нет в архиве с клиентом.',
  'Можно скрыть неиспользуемые плагины. Для этого нужно написать имя плагина в файле off.txt'
}
