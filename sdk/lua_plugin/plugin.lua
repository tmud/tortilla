...
-- таблица для программного интерфейса плагина
local plugin = {}
...
-- 4. Название файла плагина должно совпадать с названием самого плагина.
-- 5. Повсеместно используйте ключевое слово local для переменных и таблиц (кроме таблицы модуля, чтобы он был виден клиенту). 
...
return plugin               -- возврщаем таблицу плагина (его программного интерфейса).