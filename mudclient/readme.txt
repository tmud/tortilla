Tortilla Mud Client v0.93
Исправлены ошибки:
- Попадание в командную строку символов \r\n из буфера обмена, 
  в результате чего клиент неправильно их обрабатывал.
- Неверная обработка составных команд, если использовались переменные ($var).
Расширен api клиента (добавлены функции barcmd, historycmd).
Написан плагин для фильтрации команд (чтобы не попадали они в историю).
